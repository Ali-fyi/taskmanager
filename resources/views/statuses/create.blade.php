<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2 text-sm text-gray-500">
            ...
            <span>/</span>
            <span class="text-gray-800 font-medium">Nouveau</span>
        </div>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('workspaces.statuses.store', $workspace) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                :value="old('name')" placeholder="Ex : En revue, Bloqué..." autofocus />
                        ...
                        <div class="mt-6">
                            ...
                            <div class="mt-1 flex items-center gap-3">
                                ...
                                <span class="text-sm text-gray-500">Couleur d'identification du statut.</span>
                            </div>
                        ...
                        <div class="mt-6 flex items-center gap-4">
                            <x-primary-button>Créer le statut</x-primary-button>
