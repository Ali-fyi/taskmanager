<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2 text-sm text-gray-500">
            ...
            <span>/</span>
            <span class="text-gray-800 font-medium">Nouvelle tâche</span>
        </div>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 sm:p-8">
                    ...
                    <form method="POST" action="{{ route('workspaces.projects.tasks.store', [$workspace, $project]) }}">
                        ...
                        {{-- Titre --}}
                        <div>
                            <x-input-label for="title" value="Titre de la tâche" />
                            <x-text-input id="title" name="title" type="text" class="mt-1 block w-full"
                                :value="old('title')" placeholder="Ex : Créer la page d'accueil..." autofocus />
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="description" name="description" rows="3"
                                ...
                                placeholder="Détaillez cette tâche...">{{ old('description') }}</textarea>
                        ...
                        <div class="mt-6 flex items-center gap-4">
                            <x-primary-button>Créer la tâche</x-primary-button>
